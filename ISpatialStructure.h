 ...
 *  SpatialTest Project
 *
 *  Interface which all tested structures must implement. Provides a set of methods which will be used in testing.
 *
...
#if !defined(ST_INTERFACE_SPATIALSTRUCTURE_H)
#define ST_INTERFACE_SPATIALSTRUCTURE_H
...
namespace SpatialTest
{
    class ISpatialStructure
    {
        ...
        public:
            ...
            // [rad] Adding objects into the structure
            virtual void        VAddObjects(const std::vector<ISpatialObject*>& refObjects) = 0;
            
            // [rad] Updating / detecting collisions in the structure
            virtual void        VUpdate() = 0;            
    
    };
}

#endif //!defined(ST_INTERFACE_SPATIALSTRUCTURE_H)
